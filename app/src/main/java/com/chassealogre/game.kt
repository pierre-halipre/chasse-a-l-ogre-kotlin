...
class Game(
    ...
    fun clear_bounds(device: Device) {
        ...
        window.drawing.drawRect(x_min, y_min, left, y_max, window.paint)
        window.drawing.drawRect(right, y_min, x_max, y_max, window.paint)
        window.drawing.drawRect(left, y_min, right, top, window.paint)
        window.drawing.drawRect(left, bottom, right, y_max, window.paint)
    }
